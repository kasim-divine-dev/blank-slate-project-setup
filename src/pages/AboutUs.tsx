          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              {Object.keys(tabContent).map((tab) => (
                <button
                  ...
                  className={`px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 capitalize ${activeTab === tab
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="bg-black rounded-3xl p-8 md:p-12 border border-darkText20"
              >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {values.map((value, index) => (
                <motion.div
                  key={value.title}
                  className={`value-card relative bg-gradient-to-br ${value.gradient} backdrop-blur-sm border border-darkText20 p-8 rounded-3xl group hover:border-lightBg/50 transition-all duration-500`}
