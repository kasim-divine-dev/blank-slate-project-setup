        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              >
                Featured <span className="block text-transparent bg-gradient-to-r from-darkText via-lightBg to-darkText bg-clip-text">
                  Projects
                </span>
              </h1>
              <p
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              <div className="flex flex-col items-start gap-3">
                <div className="max-md:hidden flex items-center gap-2 text-darkText60 mr-4 max-md:p-2">
              ...
              <div className="flex flex-col md:items-center items-end gap-6 max-md:w-full">
                <div className="text-base text-darkText60">
                  Showing {startIndex + 1}-{Math.min(startIndex + projectsPerPage, filteredProjects.length)} of {filteredProjects.length} projects
                </div>

                <div className="max-md:hidden flex items-center gap-2 p-1 bg-darkText20 rounded-lg">
                  <button
