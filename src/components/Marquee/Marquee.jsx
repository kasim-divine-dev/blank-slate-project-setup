    ...
    <div className="marquee ">
      <div className="marquee-wrapper" ref={wrapperRef}>
        <div className="marquee-content">
          <h1 className="uppercase font-boska-black text-8xl tracking-[1rem] whitespace-nowrap pr-12 will-change-transform">
            Your Vision, Our Technology — Your Vision, Our Technology — Your Vision, Our Technology —
